...
export async function sendRegistrationEmail(type: 'registration_approved'|'registration_pending'|'registration_rejected'|'registration_cancelled', event: Event, registration: {name: string; email: string; cancelToken?: string}, reason?: string) {
